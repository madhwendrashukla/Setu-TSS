      ...
      workshops: [
        {
          ...
          duration: '3 Hours',
          key_features: '<p>Term Sheets · Co-Founder Agreements · Liquidation Preference · Equity & Dilution · AI Drafting Risks · Founder Networking</p>',
          pricing: {
            mode: 'offline',
          ...
          detail_bullets: {
            what_youll_learn: '<ul><li>11:30 AM – 12:00 PM — Foundations of Startup Agreements: Equity split, 4-year reverse vesting, 1-year cliff, and IP assignment</li><li>12:00 PM – 12:30 PM — Decoding Co-Founder Agreements: Roles, decision deadlocks, non-compete, and founder exit mechanisms</li><li>12:30 PM – 1:00 PM — Open Q&A: Real-world founder legal dilemmas, when AI helps vs introduces fatal errors</li><li>1:00 PM – 1:30 PM — Decoding Term Sheets: 1x/2x liquidation preferences, anti-dilution, board rights, and pre/post valuation traps</li><li>1:30 PM – 2:30 PM — Founder Introductions & Open Networking: Connect with fellow builders and the SETU community</li></ul>',
            your_deliverables: '<ul><li>🎁 Bonus: Term Sheet Cheat Sheet for all attendees</li><li>Co-Founder Agreement framework & essential clause checklist</li><li>Deadlock resolution & founder exit guidelines</li><li>Valuation & Dilution reference cheat sheet</li><li>Direct connections with peer founders & mentors</li></ul>',
          },
        },
      ],
