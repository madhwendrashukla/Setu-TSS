...
export function AIWorkshopFinal() {
    ...
    return (
        <section className="py-20 relative border-t border-slate-700/50 overflow-hidden bg-[#0A0F1C]">
            ...
            <div className="flex justify-center">
                <span className="inline-flex items-center gap-3 px-12 py-5 rounded-xl font-extrabold text-slate-50/50 text-lg bg-[#1e293b] border border-slate-700/50 cursor-not-allowed">
                ...
                <div>
                    ...
                    <div className="space-y-4 max-w-4xl mx-auto">
                        {faqs.map((faq, i) => (
                            <details key={i} className="group bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] border border-slate-700/50 rounded-xl overflow-hidden">
                                <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5 text-slate-50 hover:text-[#d946ef] transition-colors">
                                    <span>{faq.q}</span>
                                    <span className="transition group-open:rotate-180 shrink-0 ml-3">
                                        <i className="fa-solid fa-chevron-down text-slate-300" />
                                    </span>
                                </summary>
                                <div className="text-slate-300 font-light p-5 pt-0 text-sm md:text-base leading-relaxed border-t border-slate-700/50 mt-2">{faq.a}</div>
                            </details>
                        ))}
                    </div>
                </div>
                ...
                <div>
                    <div className="relative group max-w-4xl mx-auto">
                        ...
                        <div className="relative text-center bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] rounded-2xl p-6 md:p-12 border border-slate-700/50">
                ...
                <div>
                    <div className="text-center mb-10">
                        ...
                        <p className="text-slate-300 text-sm md:text-base">Reach out directly or drop your details below.</p>
                    </div>
                    <div className="max-w-4xl mx-auto flex flex-col gap-8">
                        {/* WhatsApp */}
                        <div className="bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] border border-slate-700/50 rounded-2xl p-6 md:p-8 text-center hover:border-green-500/50 transition-colors group relative overflow-hidden">
                            ...
                            <h4 className="text-slate-50 font-bold text-xl mb-2 relative z-10">WhatsApp Us</h4>
                            ...
                            <a href="https://chat.whatsapp.com/JzVfrG7FXhIHHIFXtQCj2C?mode=gi_t" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-3 rounded-lg bg-green-500/10 border border-green-500/30 text-sm font-bold text-green-400 hover:bg-green-500 hover:text-slate-50 transition-all relative z-10">
                                Message Now <i className="fa-solid fa-arrow-up-right-from-square ml-1 text-xs" />
                            </a>
                        </div>

                        {/* Email form */}
                        <div className="bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] border border-slate-700/50 rounded-2xl p-6 md:p-8 relative overflow-hidden">
                            <div className="relative z-10">
                        {/* Punchy taglines */}
                        <div className="text-center mb-8">
                            <p className="text-4xl md:text-5xl font-black text-slate-50 leading-tight">
                        ...
                        <div className="mb-6 text-center">
                            <h3 className="text-xl md:text-2xl font-bold text-slate-50 mb-2">To know more about our programs, drop your details below</h3>
                        </div>
                                <form className="space-y-4" onSubmit={handleQuerySubmit}>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            <label className="text-xs font-medium text-slate-300">Name</label>
                                            <input type="text" required placeholder="Your Full Name" value={queryForm.name} onChange={e => setQueryForm(p => ({ ...p, name: e.target.value }))} className="w-full bg-[#161e31] border border-slate-700/50 rounded-lg px-4 py-3 text-slate-50 text-sm focus:outline-none focus:border-[#8b5cf6] transition-colors placeholder:text-slate-600" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-xs font-medium text-slate-300">City</label>
                                            <input type="text" required placeholder="e.g. Mumbai, Delhi" value={queryForm.city} onChange={e => setQueryForm(p => ({ ...p, city: e.target.value }))} className="w-full bg-[#161e31] border border-slate-700/50 rounded-lg px-4 py-3 text-slate-50 text-sm focus:outline-none focus:border-[#8b5cf6] transition-colors placeholder:text-slate-600" />
                                        </div>
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-xs font-medium text-slate-300">Email Address</label>
                                        <input type="email" required placeholder="you@example.com" value={queryForm.email} onChange={e => setQueryForm(p => ({ ...p, email: e.target.value }))} className="w-full bg-[#161e31] border border-slate-700/50 rounded-lg px-4 py-3 text-slate-50 text-sm focus:outline-none focus:border-[#8b5cf6] transition-colors placeholder:text-slate-600" />
                                    </div>
                                    <div className="space-y-1.5">
                        ...
                        <div className="relative border border-white/8 rounded-3xl overflow-hidden" style={{ background: 'linear-gradient(160deg, rgba(139,92,246,0.06) 0%, rgba(15,23,42,0.95) 40%, rgba(217,70,239,0.04) 100%)' }}>
                            ...
                            <div className="px-8 py-16 md:px-20 md:py-20 text-center">
                                ...
                                <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.05] mb-8">
                                    <span className="text-slate-50">Your startup idea</span>
                                    <br />
                                ...
                                {/* Supporting line */}
                                <p className="text-slate-300 text-lg md:text-xl font-light max-w-lg mx-auto mb-12 leading-relaxed">
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                    <span
                                        className="relative group w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-10 py-4 md:px-12 md:py-5 rounded-2xl font-bold text-base md:text-lg text-slate-50/50 bg-[#1e293b] border border-slate-700/50 cursor-not-allowed"
                                    >
                                    ...
                                    <a
                                        ...
                                        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-semibold text-sm text-slate-300 border border-slate-700/50 hover:border-white/25 hover:text-slate-50 transition-all duration-300"
                                    >
