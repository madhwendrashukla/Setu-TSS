...
export function AIWorkshopFinal() {
    ...
    return (
        <section className="py-20 relative border-t border-functional-border overflow-hidden bg-[#0A0F1C]">
            ...
            <div className="flex justify-center">
                <span className="inline-flex items-center gap-3 px-12 py-5 rounded-xl font-extrabold text-text-primary/50 text-lg bg-[#1e293b] border border-functional-border cursor-not-allowed">
                    ...
                    <div className="space-y-4 max-w-4xl mx-auto">
                        {faqs.map((faq, i) => (
                            <details key={i} className="group bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] border border-functional-border rounded-xl overflow-hidden">
                                ...
                                <div className="text-text-secondary font-light p-5 pt-0 text-sm md:text-base leading-relaxed border-t border-functional-border mt-2">{faq.a}</div>
                            </details>
                        ))}
                    </div>
                </div>
                ...
                <div>
                    <div className="relative group max-w-4xl mx-auto">
                        ...
                        <div className="relative text-center bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] rounded-2xl p-6 md:p-12 border border-functional-border">
                ...
                <div>
                    <div className="text-center mb-10">
                        ...
                        <p className="text-text-secondary text-sm md:text-base">Reach out directly or drop your details below.</p>
                    </div>
                    <div className="max-w-4xl mx-auto flex flex-col gap-8">
                        {/* WhatsApp */}
                        <div className="bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] border border-functional-border rounded-2xl p-6 md:p-8 text-center hover:border-green-500/50 transition-colors group relative overflow-hidden">
                            ...
                            <p className="text-sm text-text-secondary mb-6 font-light relative z-10">Get instant replies for your queries directly from our team.</p>
                            <a href="https://chat.whatsapp.com/JzVfrG7FXhIHHIFXtQCj2C?mode=gi_t" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-3 rounded-lg bg-green-500/10 border border-green-500/30 text-sm font-bold text-green-400 hover:bg-green-500 hover:text-text-primary transition-all relative z-10">
                        ...
                        <div className="text-center mb-8">
                            <p className="text-4xl md:text-5xl font-black text-text-primary leading-tight">
                        ...
                        <div className="mb-6 text-center">
                            <h3 className="text-xl md:text-2xl font-bold text-text-primary mb-2">To know more about our programs, drop your details below</h3>
                        </div>
                        ...
                        <div className="relative border border-white/8 rounded-3xl overflow-hidden" style={{ background: 'linear-gradient(160deg, rgba(139,92,246,0.06) 0%, rgba(15,23,42,0.95) 40%, rgba(217,70,239,0.04) 100%)' }}>
                            ...
                            <div className="px-8 py-16 md:px-20 md:py-20 text-center">
                                ...
                                <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.05] mb-8">
                                    <span className="text-text-primary">Your startup idea</span>
                                    <br />
                                ...
                                {/* Supporting line */}
                                <p className="text-text-secondary text-lg md:text-xl font-light max-w-lg mx-auto mb-12 leading-relaxed">
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                    <span
                                        className="relative group w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-10 py-4 md:px-12 md:py-5 rounded-2xl font-bold text-base md:text-lg text-text-primary/50 bg-[#1e293b] border border-functional-border cursor-not-allowed"
                                    >
                                    ...
                                    <a
                                        ...
                                        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-semibold text-sm text-text-secondary border border-functional-border hover:border-white/25 hover:text-text-primary transition-all duration-300"
                                    >
