    ...
    return (
        <header className="relative pt-32 pb-16 md:pt-44 md:pb-24 lg:pt-56 lg:pb-32 overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
                ...
                {/* Single top badge */}
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-slate-700/50 text-xs md:text-sm text-[#d946ef] backdrop-blur-md font-medium mb-6 md:mb-8">
                ...
                <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-2 md:mb-4 leading-[1.1] text-slate-50">
                ...
                <div className="flex items-center justify-center gap-3 mb-4">
                    ...
                    <p className="text-base md:text-2xl lg:text-3xl font-semibold tracking-wide text-slate-300 flex flex-nowrap items-center whitespace-nowrap gap-1.5 md:gap-2">
                        ...
                        <span className="font-extrabold text-slate-50 shrink-0">THE</span>
                        <span className="font-extrabold bg-gradient-to-r from-[#8b5cf6] to-[#d946ef] bg-clip-text text-transparent shrink-0">STARTUP</span>
                        <span className="font-extrabold text-slate-50 shrink-0">SCHOOL</span>
                    </p>
                ...
                <p className="mt-6 max-w-2xl mx-auto text-lg md:text-2xl text-slate-50 font-medium mb-8 leading-relaxed px-2">
                    Build Validate and Launch your Startup in 3 days
                </p>

                {/* Stats */}
                <div className="w-full flex justify-center mb-10 md:mb-14 px-2">
                    <div className="inline-flex flex-nowrap items-center justify-center gap-1.5 min-[380px]:gap-2 sm:gap-3 md:gap-5 text-[9px] min-[360px]:text-[10px] sm:text-xs md:text-lg text-slate-50 font-semibold tracking-wide whitespace-nowrap bg-[rgba(15,23,42,0.4)] backdrop-blur-md border border-slate-700/50 rounded-full px-3 py-2 md:px-8 md:py-3.5 shadow-lg">
                        <span>3 Mentors</span>
                ...
                <div className="relative group inline-block w-full sm:w-auto">
                    <span className="relative w-full sm:w-auto px-8 py-4 md:px-10 md:py-5 text-base md:text-lg font-bold rounded-xl text-slate-50/50 bg-[#1e293b] flex items-center justify-center cursor-not-allowed border border-slate-700/50">
