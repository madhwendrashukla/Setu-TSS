...
export function AIWorkshopStoryline() {
    return (
        <section className="py-16 md:py-24 relative z-10 border-t border-slate-700/50" id="story">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-slate-50 leading-tight">
                        Sound familiar?
                    </h2>
                </div>
                        ...
                        {story.map((s, i) => {
                            ...
                            return (
                                <div key={i} className="relative flex items-start">
                                    ...
                                    >
                                        <div className={`relative bg-[rgba(15,23,42,0.7)] backdrop-blur-[16px] border rounded-2xl p-4 md:p-8 transition-all duration-300 hover:-translate-y-1 ${s.highlight ? 'border-[#8b5cf6]/50 shadow-[0_0_30px_rgba(139,92,246,0.15)]' : 'border-slate-700/50 hover:border-slate-700/50'}`}>
                                            {s.highlight && (
                                                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#8b5cf6]/5 to-[#d946ef]/5 pointer-events-none" />
                                            )}
                                            <h3 className={`text-sm md:text-xl font-extrabold mb-2 md:mb-3 leading-snug ${s.highlight ? 'bg-gradient-to-r from-[#8b5cf6] to-[#d946ef] bg-clip-text text-transparent' : 'text-slate-50'}`}>
                                                {s.heading}
                                            </h3>
                                            ...
                                            {s.highlight && (
                                                <a href="#pricing" className="mt-4 inline-flex items-center gap-1.5 px-3 py-2 md:px-5 md:py-2.5 rounded-xl bg-gradient-to-r from-[#8b5cf6] to-[#d946ef] text-slate-50 text-xs md:text-sm font-bold hover:opacity-90 transition-opacity">
                ...
                <div className="mt-16 md:mt-20 text-center">
                    <div className="relative max-w-3xl mx-auto">
                        ...
                        <div className="relative bg-[rgba(15,23,42,0.8)] backdrop-blur-[16px] border border-[#8b5cf6]/30 rounded-2xl px-6 py-8 md:p-12">
                            <p className="text-xl md:text-2xl lg:text-3xl font-bold text-slate-50 leading-snug mb-2">
                                More than Knowledge,
                            </p>
                            ...
                            <p className="mt-5 text-slate-300 text-base md:text-lg font-light">
