...
export default function AIWorkshopPage() {
    return (
        <div className="antialiased relative pb-16" style={{ backgroundColor: '#0f172a', color: '#f8fafc', overflowX: 'hidden' }}>
            ...
            {/* Navigation */}
            <nav className="fixed w-full z-50 bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] border-b border-slate-700/50 transition-all duration-300">
                    ...
                    <div className="flex justify-between items-center h-16 md:h-20">
                        ...
                        <div>
                            <div className="relative group">
                                ...
                                <span className="relative inline-flex items-center justify-center px-3 py-1.5 md:px-5 md:py-2.5 text-[11px] md:text-sm font-semibold rounded-lg text-slate-50/50 bg-[#0f172a] border border-slate-700/50 whitespace-nowrap cursor-not-allowed">
            ...
            {/* Footer */}
            <footer className="border-t border-slate-700/50 py-10 bg-[#0A0F1C]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex flex-col items-center md:items-start gap-0.5">
                            ...
                            <p className="text-[9px] text-slate-50 tracking-wide uppercase pl-10">RAMSETU ALTERNATE EDUCATION SOLUTIONS PVT LTD</p>
                        </div>
