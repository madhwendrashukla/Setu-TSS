    ...
    return (
        <div className="pt-24 pb-20 min-h-screen bg-bg-main flex flex-col items-center">
            ...
            <div className="max-w-5xl mx-auto px-6 mb-20 text-center relative w-full mt-10">
                ...
                <h1 className="text-6xl md:text-7xl font-black text-text-primary tracking-[-0.04em] mb-6">
                    Our <span className="text-text-primary/40">Mission.</span>
                </h1>
            ...
            <div className="w-full max-w-6xl mx-auto px-6 mb-24">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Value 1 */}
                    <div className="bg-white/5 border border-functional-border p-8 rounded-3xl backdrop-blur-sm hover:bg-white/10 transition-colors">
                        ...
                        <h3 className="text-2xl font-bold text-text-primary mb-4">Innovation First</h3>
                    ...
                    <div className="bg-white/5 border border-functional-border p-8 rounded-3xl backdrop-blur-sm hover:bg-white/10 transition-colors">
                        ...
                        <h3 className="text-2xl font-bold text-text-primary mb-4">Community Led</h3>
                        <p className="text-text-secondary leading-relaxed">
                    ...
                    <div className="bg-white/5 border border-functional-border p-8 rounded-3xl backdrop-blur-sm hover:bg-white/10 transition-colors">
                        ...
                        <h3 className="text-2xl font-bold text-text-primary mb-4">Real Impact</h3>
                        <p className="text-text-secondary leading-relaxed">
            ...
            <div className="w-full max-w-6xl mx-auto px-6 mb-24">
                <div className="bg-white/5 border border-functional-border p-10 md:p-14 rounded-3xl backdrop-blur-md relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center">
                        <div className="w-full md:w-1/3 flex justify-center">
                            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full border-4 border-functional-border overflow-hidden shrink-0 shadow-2xl">
                                <img 
                        ...
                        <div className="w-full md:w-2/3">
                            <h2 className="text-3xl md:text-4xl font-black text-text-primary tracking-[-0.04em] mb-6">
                            ...
                            <div className="space-y-6 text-text-secondary text-lg leading-relaxed">
                                ...
                                <div className="pt-4 border-t border-functional-border mt-6">
                                    <p className="font-bold text-text-primary text-xl">The Startup School Founders</p>
            ...
            <div className="w-full max-w-5xl mx-auto px-6 mb-24 text-center">
                <h2 className="text-4xl md:text-5xl font-black text-text-primary tracking-[-0.04em] mb-8">
                    Our <span className="text-text-primary/40">Vision.</span>
                </h2>
                <div className="bg-gradient-to-r from-white/5 to-white/5 border border-functional-border p-10 md:p-14 rounded-3xl backdrop-blur-md">
