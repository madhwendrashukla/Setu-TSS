...
export default function AdminCertifications() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        const url = editing ? `${API}/api/admin/certification-logos/${editing.id}` : `${API}/api/admin/certification-logos`;
    ...
    const handleDelete = async (id: string) => {
        ...
        await fetch(`${API}/api/admin/certification-logos/${id}`, { method: "DELETE", headers: { "Authorization": `Bearer ${token()}` } });
        fetchLogos();
    };
    ...
    const handleReorder = async (newItems: any[]) => {
        ...
        setLogos(reordered);
        await fetch(`${API}/api/admin/certification-logos/reorder`, {
            method: "PUT",
                ...
                <table className="w-full text-left">
                    <thead className="bg-gray-50 border-b border-gray-200 text-gray-500 text-sm">
                        <tr>
                            ...
                            <th className="p-4 font-normal">Certification Name</th>
                ...
                <div className="fixed inset-0 bg-white/70 flex items-center justify-center z-50 p-4">
                    <div className="bg-white border border-gray-200 rounded-2xl w-full max-w-lg p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                <label className="block text-sm text-gray-500 mb-1">Certification Name *</label>
