        ...
        <div className="animate-in fade-in zoom-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="group relative overflow-hidden bg-gradient-to-br from-white/10 to-white/5 p-8 rounded-3xl border border-white/10 hover:border-accent-blue/50 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(139,92,246,0.3)]">
                    ...
                    <h3 className="text-white/50 mb-2 font-medium tracking-wide uppercase text-xs">Active Events</h3>
                    <p className="text-5xl font-black text-white mb-2">{stats?.events ?? '—'}</p>
                    <div className="text-xs text-white/40 inline-block px-2 py-1 rounded-full bg-white/5">Live on site</div>
                </div>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-white/10 to-white/5 p-8 rounded-3xl border border-white/10 hover:border-accent-blue/50 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(139,92,246,0.3)]">
                    ...
                    <p className="text-5xl font-black text-white mb-2">{stats?.mentors ?? '—'}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                    <h3 className="text-white/50 mb-1 text-xs uppercase tracking-wide">Programs</h3>
                    <p className="text-3xl font-black text-white">{stats?.programs ?? '—'}</p>
                </div>
                <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                    <h3 className="text-white/50 mb-1 text-xs uppercase tracking-wide">Gallery Items</h3>
                    <p className="text-3xl font-black text-white">{stats?.gallery ?? '—'}</p>
                </div>
                <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                    <h3 className="text-white/50 mb-1 text-xs uppercase tracking-wide">Partners</h3>
                    <p className="text-3xl font-black text-white">{stats?.partners ?? '—'}</p>
                </div>
            </div>
