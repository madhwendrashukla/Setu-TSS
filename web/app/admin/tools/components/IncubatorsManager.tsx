                            ...
                            <tbody className="divide-y divide-white/10">
                                {paginatedItems.map(item => (
                                    <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="p-4 text-gray-600">{(item.focus || []).join(", ")}</td>
                ...
                <div className="fixed inset-0 bg-white/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white border border-gray-200 rounded-2xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto custom-scrollbar">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            ...
                            <input type="text" placeholder="Focus Sectors (comma separated)" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3" value={formData.focus} onChange={e => setFormData({...formData, focus: e.target.value})} />
                            <input type="text" placeholder="Program Length" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3" value={formData.programLength} onChange={e => setFormData({...formData, programLength: e.target.value})} />
                            <input type="text" placeholder="Equity Taken" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3" value={formData.equityTaken} onChange={e => setFormData({...formData, equityTaken: e.target.value})} />
                            <input type="text" placeholder="Website URL" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3" value={formData.website} onChange={e => setFormData({...formData, website: e.target.value})} />
