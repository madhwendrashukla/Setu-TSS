    ...
    return (
        <div className="pt-32 pb-20 min-h-screen bg-bg-main relative overflow-hidden">
            ...
            <main className="max-w-5xl mx-auto px-6 relative z-10">
                ...
                <div className="mb-12 flex items-center justify-between border-b border-functional-border pb-6">
                    <Link href="/events" className="group text-text-secondary hover:text-text-primary flex items-center gap-2 transition duration-300 font-medium text-sm">
                        <i className="fas fa-arrow-left group-hover:-translate-x-1 transition-transform"></i> Back to Events
                    </Link>
                    <Link href="/events" className="text-xl font-black text-text-primary tracking-tighter hidden md:block group">
                        THE <span className="text-accent-blue group-hover:text-text-primary transition-colors">STARTUP</span> SCHOOL <span className="text-text-secondary font-light">EVENTS</span>
                    </Link>
                </div>

                {/* Hero Section */}
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-functional-border text-text-primary text-xs font-bold uppercase tracking-widest mb-8">
                        Past Event
                    </div>
                    <h1 className="text-5xl md:text-5xl font-black text-text-primary mb-6 tracking-tight leading-tight">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-20">
                    <div className="glass-card p-10 rounded-3xl border border-functional-border relative overflow-hidden group hover:border-functional-border transition-colors">
                        <Image 
                        ...
                        <div className="relative z-10 text-center flex flex-col items-center">
                            <div className="w-16 h-16 rounded-full bg-white/5 border border-functional-border flex items-center justify-center text-accent-blue mb-8">
                            ...
                            <p className="text-text-primary text-2xl font-bold tracking-tight mb-2">Friday, 14th Feb</p>
                    ...
                    <div className="glass-card p-10 rounded-3xl border border-functional-border relative overflow-hidden group hover:border-functional-border transition-colors">
                        ...
                        />
                        <div className="relative z-10 text-center flex flex-col items-center">
                            <div className="w-16 h-16 rounded-full bg-white/5 border border-functional-border flex items-center justify-center text-accent-violet mb-8">
                                <i className="fas fa-map-marker-alt text-2xl"></i>
                            </div>
                            <h3 className="text-sm font-bold tracking-[0.2em] text-text-secondary uppercase mb-4">WHERE</h3>
                            <p className="text-text-primary text-2xl font-bold tracking-tight mb-2">DevX, Andheri East</p>
                ...
                {/* Content Section */}
                <div className="glass-card p-10 md:p-16 rounded-3xl border border-functional-border mb-20">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-3xl font-bold text-text-primary mb-10 tracking-tight">What You Experienced</h2>

                            <div className="space-y-12">
                                <div className="flex gap-6 items-start">
                                    <div className="text-accent-blue mt-1"><i className="fas fa-check-circle text-xl"></i></div>
                                    <div>
                                        <h4 className="text-xl font-bold text-text-primary mb-2">Ice-Breaking Introductions</h4>
                                ...
                                <div className="flex gap-6 items-start">
                                    <div className="text-accent-blue mt-1"><i className="fas fa-check-circle text-xl"></i></div>
                                    <div>
                                        <h4 className="text-xl font-bold text-text-primary mb-2">Expert Session</h4>
                                ...
                                <div className="flex gap-6 items-start">
                                    <div className="text-accent-blue mt-1"><i className="fas fa-check-circle text-xl"></i></div>
                                    <div>
                                        <h4 className="text-xl font-bold text-text-primary mb-2">Match Making</h4>
                                ...
                                <div className="flex gap-6 items-start">
                                    <div className="text-accent-blue mt-1"><i className="fas fa-check-circle text-xl"></i></div>
                                    <div>
                                        <h4 className="text-xl font-bold text-text-primary mb-2">Breakout Sessions</h4>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-4">
                                <div className="rounded-2xl overflow-hidden border border-functional-border aspect-[4/5] relative">
                                    <Image src="/gallery/IMG_1371.JPG" alt="Event photo" fill className="object-cover" />
                                </div>
                                <div className="rounded-2xl overflow-hidden border border-functional-border aspect-square relative">
                ...
                <div className="mb-20">
                    <div className="text-center mb-10">
                        <h2 className="text-3xl font-bold text-text-primary mb-4 tracking-tight">Community Moments</h2>
                ...
                <div className="text-center pb-10">
                    <h3 className="text-2xl font-bold text-text-primary mb-6">Want to attend the next one?</h3>
