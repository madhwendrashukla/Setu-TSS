        ...
        <section className="py-16 md:py-24 relative" id="curriculum">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-8 md:space-y-10">
                        ...
                        <div className="md:flex gap-8 lg:gap-12 items-start">
                            <div className="md:w-1/3 mb-8 md:mb-0">
                                ...
                                <div className="bg-slate-800/50 rounded-xl p-4 md:p-5 border border-functional-border relative overflow-hidden">
                                    ...
                                    <p className="text-xs md:text-sm font-medium text-text-primary">Walk away with a clear roadmap of the fundraising landscape.</p>
                                </div>
                            </div>

                            <div className="md:w-2/3">
                                <h4 className="text-xl md:text-2xl font-bold mb-4 pb-3 border-b border-functional-border text-text-primary">What do you get in this workshop:</h4>
                    ...
                    <div className="bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] border border-functional-border shadow-[0_4px_30px_rgba(0,0,0,0.1)] rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-12 border-2 border-[#8b5cf6]/40 shadow-[0_0_30px_rgba(217,70,239,0.1)] md:shadow-[0_0_40px_rgba(217,70,239,0.15)] relative overflow-hidden">
                        <div className="absolute top-0 right-0 bg-gradient-to-r from-[#8b5cf6] to-[#d946ef] text-text-primary text-[10px] md:text-xs font-bold px-4 py-1.5 md:px-6 md:py-2 rounded-bl-xl md:rounded-bl-2xl uppercase tracking-widest shadow-lg z-20">Most Advanced</div>
                        <div className="md:flex gap-8 lg:gap-12 items-start mt-2 md:mt-0">
                            <div className="md:w-1/3 mb-8 md:mb-0">
                                <div className="inline-block px-3 py-1 md:px-4 md:py-1.5 bg-gradient-to-r from-[#8b5cf6] to-[#d946ef] text-text-primary font-bold rounded-lg text-xs md:text-sm mb-4 shadow-lg shadow-[#d946ef]/30">LEVEL 2: ADVANCED COHORT</div>
                                <h3 className="text-2xl md:text-3xl font-bold mb-1 md:mb-2 text-text-primary">Fund Raising Advanced</h3>
                                <div className="mt-6 md:mt-8 mb-6 md:mb-8">
                                    <h4 className="text-text-primary text-sm md:text-base font-semibold mb-2 md:mb-3 flex items-center gap-2">
                            ...
                            <div className="md:w-2/3">
                                <h4 className="text-lg md:text-xl font-bold mb-4 pb-3 border-b border-functional-border text-transparent bg-clip-text bg-gradient-to-r from-[#8b5cf6] to-[#d946ef]">What this workshop shall cover (Advanced):</h4>
                                ...
                                <div className="mt-8 border border-[#d946ef]/30 rounded-2xl p-6 relative overflow-hidden backdrop-blur-md bg-[#d946ef]/5">
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-4 text-sm text-text-primary font-light relative z-10">
