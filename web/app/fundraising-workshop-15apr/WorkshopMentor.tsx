        ...
        <section className="py-20 md:py-24 bg-transparent text-white border-t border-[#333333] relative z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] border border-functional-border rounded-xl p-6 hover:border-[#8b5cf6] transition-all duration-300 group flex flex-col h-full transform hover:-translate-y-2">
                        <h3 className="text-xl font-bold text-white mb-4 text-center">Mentor Panel: E-Cell IIT Madras</h3>
                        <div className="aspect-video bg-[#0f172a] rounded-lg mb-6 flex items-center justify-center border border-functional-border group-hover:border-[#8b5cf6]/50 transition relative overflow-hidden">
                        ...
                        <a href="https://www.linkedin.com/posts/gauravbansal2_mentor-iit-startup-activity-7404790908174450688-P0G5?utm_source=social_share_send&utm_medium=member_desktop_web&rcm=ACoAADU8MA4Bu-Z-EZKMZRNCs9TMRf6ND89yVds" target="_blank" rel="noopener noreferrer" className="block w-full text-center border border-functional-border text-white font-bold py-3 rounded-lg hover:bg-white/5 hover:text-[#8b5cf6] transition-colors">
                            <i className="fa-brands fa-linkedin mr-2" /> Explore More
                        </a>
                    </div>

                    <div className="bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] border border-functional-border rounded-xl p-6 hover:border-[#d946ef] transition-all duration-300 group flex flex-col h-full transform hover:-translate-y-2">
                        <h3 className="text-xl font-bold text-white mb-4 text-center">IIM ROHTAK: JUDGE & MENTOR</h3>
                        <div className="aspect-video bg-[#0f172a] rounded-lg mb-6 flex items-center justify-center border border-functional-border group-hover:border-[#d946ef]/50 transition relative overflow-hidden">
                        ...
                        <a href="https://www.linkedin.com/in/gauravbansal2/details/featured/" target="_blank" rel="noopener noreferrer" className="block w-full text-center border border-functional-border text-white font-bold py-3 rounded-lg hover:bg-white/5 hover:text-[#d946ef] transition-colors">
                    ...
                    <div className="bg-[rgba(15,23,42,0.6)] backdrop-blur-[16px] border border-functional-border rounded-xl p-6 hover:border-red-500 transition-all duration-300 group flex flex-col h-full transform hover:-translate-y-2">
                        ...
                        <a href="https://www.youtube.com/watch?v=tt_PVE_A3wU" target="_blank" rel="noopener noreferrer" className="block w-full text-center border border-functional-border text-white font-bold py-3 rounded-lg hover:bg-white/5 hover:text-red-500 hover:border-red-500 transition-colors">
...
function VideoThumbnail({ videoId }: { videoId: string }) {
    ...
    return (
        <div className="aspect-video bg-[#0f172a] rounded-lg mb-6 flex items-center justify-center border border-functional-border group-hover:border-red-500/50 transition relative overflow-hidden cursor-pointer"
            onClick={(e) => {
