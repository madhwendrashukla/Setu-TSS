                ...
                <main className="relative z-10 min-h-screen flex flex-col items-center pt-12 md:pt-24 pb-24 px-6">
                    ...
                    <header className="text-center mb-14 w-full max-w-lg md:max-w-2xl">
                        <div className="reveal delay-1 relative inline-block mb-8">
                            ...
                            {/* Verified Badge */}
                            <div className="absolute bottom-3 right-3 md:bottom-5 md:right-5 bg-blue-500 text-text-primary w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center border-[4px] border-[#050810] shadow-lg">
                                <i className="fas fa-check text-[10px] md:text-sm"></i>
                            </div>
                        </div>

                        <h1 className="reveal delay-2 text-4xl md:text-6xl font-black text-text-primary tracking-tight mb-12">Gaurav Bansal</h1>
                        
                        <div className="reveal delay-2 relative max-w-sm md:max-w-xl mx-auto">
                            <div className="glass-card p-8 md:p-10 rounded-3xl border-functional-border">
                                <p className="text-[16px] md:text-2xl text-text-secondary font-serif italic leading-relaxed">
                    ...
                    <div className="w-full max-w-lg md:max-w-2xl space-y-14">
                        ...
                        <div className="space-y-5">
                            ...
                            <a href="https://www.linkedin.com/company/the-startup-school-2026/" target="_blank" rel="noreferrer" className="reveal delay-3 glass-card flex items-center justify-between p-5 md:p-6 rounded-3xl group">
                                <div className="flex items-center gap-5">
                                    ...
                                    <span className="font-bold text-text-primary md:text-2xl">Setu - TheStartupSchool LinkedIn</span>
                                </div>
                                <i className="fas fa-chevron-right text-slate-700 group-hover:text-text-primary transition-all mr-3"></i>
                            </a>
                            ...
                            <a href="https://www.instagram.com/the__startup__school" target="_blank" rel="noreferrer" className="reveal delay-4 glass-card flex items-center justify-between p-5 md:p-6 rounded-3xl group">
                                <div className="flex items-center gap-5">
                                    ...
                                    <span className="font-bold text-text-primary md:text-2xl">Follow our Instagram</span>
                                </div>
                                <i className="fas fa-chevron-right text-slate-700 group-hover:text-text-primary transition-all mr-3"></i>
                            </a>
                        </div>
                        ...
                        <div className="space-y-5">
                            ...
                            <a href="https://www.linkedin.com/in/gauravbansal2/" target="_blank" rel="noreferrer" className="reveal delay-4 glass-card flex items-center justify-between p-5 md:p-6 rounded-3xl group">
                                <div className="flex items-center gap-5">
                                    <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-white/5 text-text-secondary flex items-center justify-center text-2xl md:text-3xl group-hover:bg-white group-hover:text-[#050810] transition-all">
                                        <i className="fab fa-linkedin-in"></i>
                                    </div>
                                    <span className="font-bold text-text-primary md:text-2xl">Connect with Gaurav</span>
                                </div>
                                <i className="fas fa-external-link-alt text-slate-700 group-hover:text-text-primary text-xs md:text-sm transition-all mr-3"></i>
                            </a>
                            ...
                            <a href="https://www.youtube.com/watch?v=tt_PVE_A3wU" target="_blank" rel="noreferrer" className="reveal delay-4 glass-card flex items-center justify-between p-5 md:p-6 rounded-3xl group border-red-500/10">
                                <div className="flex items-center gap-5">
                                    <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-red-500/10 text-red-500 flex items-center justify-center text-2xl md:text-3xl group-hover:bg-red-500 group-hover:text-text-primary transition-all">
                                        <i className="fab fa-youtube"></i>
                                    </div>
                                    <div>
                                        <span className="block font-bold text-text-primary md:text-2xl">Founder's Hacks</span>
                                        <span className="text-[10px] md:text-[11px] text-slate-500 font-bold uppercase tracking-widest">Masterclass Video</span>
                                    </div>
                                </div>
                                <i className="fas fa-play text-red-500 group-hover:text-text-primary transition-all mr-4 text-xs md:text-sm"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <footer className="mt-24 text-center w-full max-w-lg md:max-w-2xl space-y-8 !block bg-transparent p-0 m-0 border-none shadow-none text-inherit font-inherit" style={{ display: 'block' }}>
                        {/* Save Contact Button */}
                        <button onClick={downloadVCard} className="reveal delay-4 w-full primary-cta flex items-center justify-center gap-4 py-5 md:py-6 px-10 rounded-3xl font-black text-text-primary text-base md:text-xl tracking-widest uppercase hover:scale-[1.02] transition-all shadow-2xl shadow-[#8b5cf6]/30 border-none cursor-pointer">
                        ...
                        <button 
                            ...
                            className="reveal delay-4 w-full glass-card py-5 md:py-6 px-10 rounded-3xl font-black text-text-secondary text-[11px] md:text-sm tracking-[0.4em] uppercase transition-all flex items-center justify-center gap-4 cursor-pointer"
                        ...
                        <div className="reveal delay-4 mt-20 select-none opacity-30 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-1000">
                            <div className="text-2xl md:text-5xl font-black text-text-primary tracking-tighter uppercase">
