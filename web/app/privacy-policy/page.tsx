...
export default function PrivacyPolicyPage() {
    return (
        <div className="pt-32 pb-20 min-h-screen bg-bg-main relative overflow-hidden">
            <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-accent-blue/10 rounded-full blur-[120px] pointer-events-none"></div>
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10">
                ...
                <div className="glass-card rounded-[2rem] p-8 md:p-12 space-y-10 text-text-primary/90 border border-functional-border bg-white/5 backdrop-blur-xl leading-relaxed font-normal">
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <ul className="list-disc list-inside space-y-1 ml-4 text-text-primary/90">
                                    <li>Your name</li>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4 text-text-primary/90">
                    ...
                    <section>
                        ...
                        <p className="font-medium text-text-primary">
                            ...
                            98-103, Aditya Industrial Estate, Co-Op. Premises Ltd, <br />
                            behind Evershine Mall, Chincholi Bunder,Malad West, <br />
