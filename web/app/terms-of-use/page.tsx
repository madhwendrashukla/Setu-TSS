        ...
        <div className="pt-32 pb-20 min-h-screen bg-bg-main relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10">
                <header className="text-center mb-16">
                    ...
                    <p className="text-text-primary font-medium">Effective Date: January 23, 2026</p>
                </header>
                ...
                <div className="glass-card rounded-[2rem] p-8 md:p-12 space-y-10 text-text-primary border border-functional-border bg-white/5 backdrop-blur-xl leading-relaxed font-normal">
                    ...
                    <section>
                        ...
                        <p className="text-text-primary">By accessing or using the Site, you agree to these Terms and our Privacy Policy. If you do not agree, please do not use the Site.</p>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-text-primary mb-4">2. Use of the Site</h2>
                        <div className="space-y-6">
                            <div>
                                <h3 className="text-text-primary font-semibold mb-2">Eligibility:</h3>
                                <p className="text-text-primary">You must be at least 13 years old to use the Site. By using the Site, you represent and warrant that you have the right, authority, and capacity to enter into these Terms.</p>
                            </div>
                            <div>
                                <h3 className="text-text-primary font-semibold mb-2">Account Registration:</h3>
                                <p className="text-text-primary">You may be required to create an account to access certain features of the Site. You agree to provide accurate, current, and complete information during the registration process and to update such information to keep it accurate, current, and complete. You are responsible for safeguarding your password and for any activities or actions under your account.</p>
                            </div>
                            <div>
                                <h3 className="text-text-primary font-semibold mb-2">User Conduct:</h3>
                                <p className="text-text-primary">You agree not to use the Site for any unlawful purpose or in any way that could damage, disable, overburden, or impair the Site. You agree not to use any automated system, including without limitation, "robots," "spiders," or "offline readers," to access the Site.</p>
                            </div>
                        </div>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-text-primary mb-4">3. Services</h2>
                        <p className="text-text-primary">Setu - TheStartupSchool provides educational services, business consultancy services, training services, mentoring services in online and offline training mode. The terms and conditions specific to these services will be provided separately upon request and must be agreed to before using those services.</p>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-text-primary mb-4">4. Intellectual Property</h2>
                        <p className="text-text-primary">The Site and its entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by Setu - TheStartupSchool, its licensors, or other providers of such material.</p>
                    </section>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-text-primary mb-4">6. Governing Law</h2>
                        <p className="text-text-primary">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-text-primary mb-4">7. Changes to Terms</h2>
                        <p className="text-text-primary">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-text-primary mb-4">8. Contact Us</h2>
