    ...
    return (
        <section className="card-section pt-16 md:pt-24 pb-0 relative">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 mb-16 text-center">
                ...
                <div className="text-sm md:text-lg text-text-secondary font-medium max-w-2xl mx-auto leading-relaxed [&_p]:inline [&_p]:m-0" dangerouslySetInnerHTML={{ __html: headings?.subtitle || 'Access our curated suite of tools designed to help you raise capital, <br class="hidden md:block" /> build your product, and scale your startup.' }} />
            </div>
