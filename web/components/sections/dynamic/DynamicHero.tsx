...
export function DynamicHero({ data }: { data: PageData }) {
    ...
    return (
        <section className="relative w-full min-h-[70vh] md:min-h-[80vh] flex items-center justify-center pt-24 pb-12 md:pt-40 md:pb-20 lg:pt-52 lg:pb-28 px-4 sm:px-6 overflow-hidden isolate">
            <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center w-full">
                
                {hero.headline && (
                    <h1 
                        className="w-full text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-text-primary mb-6 md:mb-8 tracking-tight md:tracking-tighter leading-[1.1] !whitespace-normal ![&_*]:whitespace-normal !break-words ![&_*]:break-words ![&_*]:max-w-full"
                ...
                {hero.description && (
                    <div 
                        className="w-full text-lg sm:text-xl md:text-3xl text-text-secondary font-medium max-w-3xl mb-8 md:mb-12 leading-relaxed px-2 sm:px-4 overflow-hidden !whitespace-normal ![&_*]:whitespace-normal !break-words ![&_*]:break-words ![&_*]:max-w-full"
