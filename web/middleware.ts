...
export function middleware(req: NextRequest) {
  ...
  const adminCsp = `default-src 'self'; script-src 'self' 'nonce-${nonce}' 'strict-dynamic'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com; font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com; img-src 'self' data: blob: https://img.youtube.com https://ui-avatars.com https://bucket-rfbkoj.s3.ap-south-1.amazonaws.com https://*.ufs.sh https://utfs.io; frame-src 'self' https://www.youtube.com https://player.vimeo.com; connect-src 'self' http://localhost:5000 https://*.razorpay.com; media-src 'self' blob: https://bucket-rfbkoj.s3.ap-south-1.amazonaws.com https://*.ufs.sh https://utfs.io; object-src 'none'; base-uri 'self'; form-action 'self'`;
